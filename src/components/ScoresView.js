    ...
    <PoseGroup>
      {showUser && (
        <UserScores key="userscores" className="section container">
          <h4 className="title is-size-6-mobile is-size-4">{showUser.name}</h4>
          <h5 className="subtitle">points received from activities</h5>
          <table className="table is-narrow is-striped is-size-6-widescreen is-size-5-fullhd">
            <thead>
              <tr>
                <th>Activity</th>
